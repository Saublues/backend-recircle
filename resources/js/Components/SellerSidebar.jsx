// Components/SellerSidebar.jsx (tidak diubah, hanya pastikan)
                    ...
                    <aside className="fixed inset-y-0 left-0 w-64 bg-white z-50 shadow-xl flex flex-col lg:hidden">
                        ...
                        <div className="p-4 border-t border-gray-100">
                            <Link
                                ...
                                method="post"
                                as="button"
                                className="flex items-center gap-3 px-4 py-3 w-full rounded-xl font-semibold text-sm text-red-500 hover:bg-red-50 transition-colors"
                            >
